...
const Scroll = mongoose.models.Scroll || mongoose.model("Scroll", scrollSchema)
...
export async function POST(req) {
    ...
    const { scrollX, scrollY, sessionId, clientId } = body || {}

    if (!isFiniteNumber(scrollX) || !isFiniteNumber(scrollY))
    ...
    await Scroll.create({ scrollX, scrollY, sessionId, clientId })
